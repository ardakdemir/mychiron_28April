...
# make the output data sepcificly
#correct_output = open('../experiment/LOG/correct_'+date_stamp+".txt", "w+")
#error_output = open('../experiment/LOG/error_'+date_stamp+".txt", "w+")
#testSet_output =  open('../experiment/LOG/testSet_'+date_stamp+".txt", "w+")
